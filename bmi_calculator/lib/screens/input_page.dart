          ...
          Expanded(
           ...
           BottomButton(
             ...
             onTap: (){
               ...
               Navigator.push(
                 context, MaterialPageRoute(builder: (context) => ResultsPage(bmiResult: calc.calculateBMI(), resultText: calc.getResults(), resultInterpretation: calc.getInterpretation(),)),
               );
             },
           ),
        ],
